...
import functions  # Importing your backend file
...
def submit_question():
    ...
    if question.strip():
        ...
        try:
            ...
            print(pdf_path)
            extracted_text = functions.preprocess_text(functions.extract_text(pdf_path))
            tokenizer = functions.load_tokenizer()
            chunks = functions.tokenize_text(extracted_text, tokenizer)

            answer = functions.answer_question(api_key, chunks, question, tokenizer)
